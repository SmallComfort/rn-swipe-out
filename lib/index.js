...
class Swipeout extends React.Component {
    ...
    performAnimation = (value = 0) => {
        if (Math.abs(this.panAnimValue - value) < 5) {
            return;
        }
    ...
    onPressChildren = () => {
        this.panAnimValue === 0 && this.props.onPress(this.panAnim);
        this.performAnimation(0);
    };
    onPressInChildren = () => {
        this.panAnimValue === 0 && this.props.onPressIn(this.panAnim);
    };
    onPressOutChildren = () => {
        this.panAnimValue === 0 && this.props.onPressOut(this.panAnim);
    };
    onLongPressChildren = () => {
        this.panAnimValue === 0 && this.props.onLongPress(this.panAnim);
    };
    ...
    renderChildren = (children) => {
        return (
            <Animated.View style={[styles.flexGrow, {
                transform: [{
                ...
                <Touchable style={[styles.flexGrow, filterContainerStyle(this.props.style)]}
                    panResponderObject={this.panResponderObject}
                    onPress={this.onPressChildren}
                    onPressIn={this.onPressInChildren}
                    onPressOut={this.onPressOutChildren}
                    onLongPress={this.onLongPressChildren}
    ...
    render() {
        return (
            <View style={[styles.container, filterSelfStyle(this.props.style)]} {...this.panHandlers}>
                ...
                {this.props.children ? this.renderChildren(this.props.children) : null}
            </View>
        );
    }
}
